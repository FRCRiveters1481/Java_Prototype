...
public class RobotMap {
	...
	public int convertAbsoluteInchesToElevatorTicks(double inches) {
		 ...
		 * y = m(x) + b
		 * 
		 * where: y is the number of ticks to send to the talon set() function m is the
		 * number of ticks per inch of elevator travel b is the number of ticks that
		 * represent the height of the lowest point the elevator can travel (the "0"
		 * tick) and the floor.
		 */
	}
